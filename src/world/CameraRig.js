...
export const KEYS = [
  ...
  { at: [1, 0.12], pose: POSE([20, 4.2, 15], [-4, 1.6, -0.5], 33) },
  { at: [1, 0.5], pose: POSE([17.5, 3.1, 4.2], [-5, 1.4, -1.6], 38) },
  { at: [1, 0.85], pose: POSE([9, 2.2, 12.8], [-8, 2.3, -0.7], 36) },
  { at: [2, 0.15], pose: POSE([35, 19, 31], [0, 3.6, 0], 28, 0.01) },
  { at: [2, 0.8], pose: POSE([42, 15, 13], [0, 4.2, 0], 27, -0.008) },
  ...
  { at: [10, 1.0], pose: POSE([15, 1.9, 12], [-5.5, 2.0, -1], 34) }
];
